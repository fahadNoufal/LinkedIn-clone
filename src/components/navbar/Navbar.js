...
const Navbar = () => {
  ...
  return (
    <div className='navbar w-full py-3 px-8 border-b-2 sticky top-0  bg-white'>
        <div className="nav-box w-5/6 flex justify-between mx-auto items-center ">
            <div className="search--section flex gap-2 w-1/2 ">
                ...
                <form action="" className="submit--btn flex text-gray-600 bg-blue-100 px-4 items-center gap-2 w-3/5">
                    ...
                    <input type="text" name="search" placeholder='Search' className=' bg-inherit outline-none placeholder:text-inherit '/>
                    <button className="search--submit hidden">btn</button>
                </form>

            </div>
            
            <ul className="nav--section flex w-2/3 justify-between text-2xl">
                <li><NavItem icon={<ImHome3/>} title='Home'/></li>
                <li><NavItem icon={<BsPeopleFill />} title='My Network' /></li>
                <li><NavItem icon={<MdOutlineWork />} title='Jobs' /></li>
                ...
                <li><NavItem icon={<BsGrid3X3GapFill />} title='Work'/></li>
                ...
                className=' underline text-red-900 opacity-90 w-28 text-center text-sm'>
